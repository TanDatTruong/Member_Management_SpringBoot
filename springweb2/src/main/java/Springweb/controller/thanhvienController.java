...
public class thanhvienController {
    ...
    public String profile(Model model, HttpSession session){
        ...
        List<thongtinsd>ttList=ttsdRepository.getListsd(matv);
        List<thongtinsd>listdangmuon=ttsdRepository.getListdangmuon(matv);
        List<thongtinsd>listdamuon=ttsdRepository.getListdamuon(matv);
